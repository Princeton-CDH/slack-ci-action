...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const slack = new webhook_1.IncomingWebhook(webhook, { channel });
            yield slack.send({
                text: 'Hello World!'
